	...
	<div class="mainSection">
		...
		<div class="comeForm">
			...
			<table class="customTable">
				...
				<tbody>
					<tr><td><input type="checkbox"></td><td>${list.approvalID}</td><td>${list.createdTime}</td><td>${list.approval_type}</td><td>${list.approvalTitle}</td><td>${list.receiverName}</td><td>${list.approval_status}</td></tr>
					</c:forEach>
				</tbody>
			</table>
