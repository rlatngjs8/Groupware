...
<input type="text" placeholder="공지사항 검색"  id="board-search-bar2" onkeyup="boardenterkey2()"><button class="search-board-button" id="search-board-button2"><img src="P_img/free-icon-magnifier-71403.png"></button>
</div>
